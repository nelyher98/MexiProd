...
class NuevoPage extends StatefulWidget{
  ...
  NuevoPage(this.handcraft);

  @override
  NuevoPageState createState() => NuevoPageState();

}

final handcraftReference = FirebaseDatabase.instance.reference().child('handcraft');

class NuevoPageState extends State<NuevoPage> {
...
void  _showToastAgregado(BuildContext context) {
